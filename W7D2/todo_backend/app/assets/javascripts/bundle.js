...
var fetchTodos = exports.fetchTodos = function fetchTodos() {
  return function (dispatch) {
    return (0, _todo_api_util.requestTodos)().then(function (res) {
...
var createTodo = exports.createTodo = function createTodo(todo) {
  return function (dispatch) {
    return (0, _todo_api_util.postTodo)(todo).then(function (res) {
...
var TodoForm = function (_React$Component) {
  ...
  _createClass(TodoForm, [{
    ...
    value: function updateTodo(e) {
      ...
      var todo = { todo: { title: e.target.value, body: "sdf", done: "false" } };
      this.setState(todo);
    }
  }, {
    key: 'handleSubmit',
